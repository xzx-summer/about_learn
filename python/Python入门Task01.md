- [Python入门Task01](#python--task01)
  * [变量、运算符与数据类型](#-----------)
    ...
    + [数据类型与转换](#-------)
      ...
      - [类型转换](#----)
    + [print()函数](#print----)
  * [<span id = "位运算">位运算</span>](#-span-id--------------span-)
    + [原码、反码、补码](#--------)
    + [按位运算](#----)
    + [利用位运算实现快速计算](#-----------)
    + [利用位运算实现整数集合](#-----------)
  ...
  * [异常处理](#----)
    + [Python标准异常总结](#python------)
    + [Python标准警告总结](#python------)
    + [try-except语句](#try-except--)
    + [try-except-finally语句](#try-except-finally--)
    + [try-except-else语句](#try-except-else--)
    + [raise语句](#raise--)
